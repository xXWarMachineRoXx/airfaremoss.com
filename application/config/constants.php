...
defined('WEBSITE') or define('WEBSITE', "airfaremoss.com");
defined('TFN') or define('TFN', "+1 888-811-2217");
defined('MAIL') or define('MAIL', "customerservice@airfaremoss.com");
defined('EMAIL') or define('EMAIL', "customerservice@airfaremoss.com");
defined('EMAIL_B') or define('EMAIL_B', "info@airfaremoss.com");
defined('EMAIL_S') or define('EMAIL_S', "support@airfaremoss.com");
defined('EMAIL_SALE') or define('EMAIL_SALE', "support@airfaremoss.com");
defined('EMAIL_SER') or define('EMAIL_SER', "support@airfaremoss.com");
defined('EMAIL_CON') or define('EMAIL_CON', "support@airfaremoss.com");
