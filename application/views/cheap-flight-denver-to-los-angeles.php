...
<div id="header-wrapper" class="wrap-inpg py-4 py-md-5"
   style="background-image: url('frontend/images/british-air.jpg'); background-position: bottom;background-no-repeat: no-repeat; background-size: cover;">
               ...
               <div class="col-md-12 col-12">
                  <div class="flight-status fs-indx bxd">
                     <a title="Flight From Denver to Los Angeles"
                        href="<?= base_url() ?>Result?depart=DEN&arrival=LAX&trip=round&page=1&departOn%5B%5D=<?= D_DATE ?>&returnOn=<?= R_DATE ?>&adult=1&child=0&infant=0&cabin=ECONOMY&airline=">
                        <div class="row align-items-end no-gutters">
                           <div class="col-lg-9 col-9"> <!-- Modify width setting -->
                              <div class="dd-box">
                                 DEN <i class="ti-exchange-vertical"></i> LAX<br>
               ...
               <div class="col-md-12 col-12">
                  <div class="flight-status fs-indx bxd">
                     <a title="Flight From Los Angeles to Denver"
                        href="<?= base_url() ?>Result?depart=LAX&arrival=DEN&trip=round&page=1&departOn%5B%5D=<?= D_DATE ?>&returnOn=<?= R_DATE ?>&adult=1&child=0&infant=0&cabin=ECONOMY&airline=">
                        <div class="row align-items-center no-gutters">
                           <div class="col-lg-9 col-9"> <!-- Modify width setting -->
                              <div class="dd-box">
                                 LAX <i class="ti-exchange-vertical"></i> DEN<br>
   ...
   <div class="container">
      ...
      <div class="all-content">
         ...
         To book a low-cost flight, passengers must go to the Airfaremoss website. Online flight booking saves money
            ...
            The most convenient option is to book your <span class="fw-bold">affordable flight tickets online</span>, but you may
            also arrange your trip by phoning our reservation number. Call us at
            <?= TFN ?> to book your flight. To take advantage of the new <span class='fw-bold'>low-cost airfare</span> with
         ...
         Airfaremoss may provide you with happiness and smiles at the lowest cost. There are several inexpensive
            ...
            <span class='fw-bold'>affordable flight journey</span>.
...
<script>
   ...
   $(document).ready(function () {
      ...
      $('#flight-info').text('Flights from DEN to LAX with Airfaremoss');
