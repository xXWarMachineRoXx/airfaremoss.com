<div class="booking-selection">
    ...
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        ...
        <li class="nav-item">
            <button type="button" class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" role="tab" aria-controls="profile" aria-selected="false"><i class="fa fa-bed" aria-hidden="true"></i> Hotel</button>
        </li>
    </ul>
        ...
        <div class="tab-pane  active" id="home" role="tabpanel" aria-labelledby="home-tab">
            ...
            <div class="search-box1">
                ...
                <form name="frm" id="sformdata" class="form" method="get" action="<?= base_url() ?>Result">
                    ...
                    <h3>Book flight ticket with Airfaremoss at lowest price</h3>
