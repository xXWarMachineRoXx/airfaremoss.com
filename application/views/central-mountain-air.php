...
document.getElementsByTagName('meta')["description"].content = "Find cheap flight at Airfaremoss. Get the best fairs With US - call us @ <?= TFN ?>";   
   ...
   <div id="header-wrapper" class="wrap-inpg py-4 py-md-5"  style="background-image: url('frontend/images/cma.jpg'); background-position: 300px 45%;background-no-repeat: no-repeat; background-size: cover;">
