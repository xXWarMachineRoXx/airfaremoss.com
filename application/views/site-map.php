      ...
      <div class="container site-map my-3 my-md-5">
         ...
         <div class="ftr-sl border rounded p-3 mb-3 d-none">
            ...
            <ul>
               ...
               <li><a href="<?= base_url() ?>book-cheap-flights-to-los-angeles">Book Cheap Flights To-los Angeles</a></li>
         ...
         <div class="ftr-sl border rounded p-3 mb-3 ">
            ...
            <li><a href="<?= base_url() ?>cheap-flight-honolulu-to-newark-liberty-intl">Honolulu to Newark Liberty Intl.</a></li>
            ...
            <li><a href="<?= base_url() ?>cheap-flight-las-vegas-to-las-toronto">Las Vegas to Toronto</a></li>
            ...
            <li><a href="<?= base_url() ?>cheap-flight-los-san-francisco-to-calgary">San Francisco to Calgary</a></li>
            <li><a href="<?= base_url() ?>cheap-flight-los-san-francisco-to-dallas">San Francisco to Dallas</a></li>
            <li><a href="<?= base_url() ?>cheap-flight-los-san-francisco-to-denver">San Francisco to Denver</a></li>
            <li><a href="<?= base_url() ?>cheap-flight-los-san-francisco-to-miami">San Francisco to Miami</a></li>
            <li><a href="<?= base_url() ?>cheap-flight-los-san-francisco-to-newark-liberty-intl">San Francisco to Newark Liberty Intl.</a></li>
            <li><a href="<?= base_url() ?>cheap-flight-los-san-francisco-to-orlando">San Francisco to Orlando</a></li>
            <li><a href="<?= base_url() ?>cheap-flight-los-san-francisco-to-phoenix">San Francisco to Phoenix</a></li>
            <li><a href="<?= base_url() ?>cheap-flight-los-san-francisco-to-san-diego">San Francisco to San Diego</a></li>
            <li><a href="<?= base_url() ?>cheap-flight-los-san-francisco-to-las-vegas">San Francisco to Las Vegas</a></li>
            <li><a href="<?= base_url() ?>cheap-flight-los-san-francisco-to-tampa">San Francisco to Tampa</a></li>
            <li><a href="<?= base_url() ?>cheap-flight-los-san-francisco-to-orlando">San Francisco to Orlando</a></li>
            ...
            <li><a href="<?= base_url() ?>cheap-flight-phoenix-to-fort-lauderdale">Phoenix to Fort Lauderdale</a></li>
            ...
            <li><a href="<?= base_url() ?>cheap-flight-phoenix-to-newark-liberty-intl">Phoenix to Newark Liberty Intl.</a></li>
